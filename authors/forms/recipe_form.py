...
class AuthorRecipeForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'servings_unit': forms.Select(choices=(('Porções', 'Porções'), ('Pedaços', 'Pedaços'), ('Pessoas', 'Pessoas'))),
            'preparation_time_unit': forms.Select(choices=(('Minutos', 'Minutos'), ('Horas', 'Horas'))),
        }
    ...
    def clean(self, *args, **kwargs):
        ...
        if title == description:
            self._my_errors['title'].append('Title cannot be the same as description.')
